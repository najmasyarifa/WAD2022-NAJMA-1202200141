  ...
  <body>
    ...
    <div class="container-fluid py-2 mx-auto">
        ...
        <?php
            ...
            $mobil = "SELECT id_mobil,foto_mobil,nama_mobil,deskripsi FROM modul3";
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="d-flex mx-auto justify-content">
                        ...
                        <button class="btn btn-danger" type="submit" name="submit" id="submit" style="margin-left: 2.5px" data-bs-dismiss="modal">Delete</button>
                    </div>
                </div>
            </div>
        </div>
