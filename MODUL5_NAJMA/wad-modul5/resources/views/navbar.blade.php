    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" style="justify-content: left;" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mx-2">
                    <a class="nav-link active" href="/mycarpage"> My Car </a>
                </li>
            </ul>
        </div>
        <div class="collapse navbar-collapse" style="justify-content: right;" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item mx-2">
                    <a href="/addcar" type="button" class="btn btn-light">Add Car</a>
                </li>
                <li class="nav-item mx-2">
                    <div class="dropdown">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="d-flex mx-auto justify-content">
                    ...
                    <a type="button" href="/" class="btn btn-danger form-control" style="margin-left: 2.5px;">Log Out</a>
                </div>
            </div>
        </div>
    </div>
